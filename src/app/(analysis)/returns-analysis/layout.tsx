    ...
    <section className="flex flex-col h-screen bg-(--main-bg-color) overflow-hidden"> 
      ...
      <div className="flex-1 overflow-y-auto pb-10">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full py-4 pl-4">
          <div className="min-h-100 col-span-2">{orderReturnsBySubcategory}</div>
          <div className="min-h-100">{customerReturnsByMonth}</div>
          <div className="min-h-100">{OrderReturnsByMonth}</div>
          <div className="min-h-100">{customerReturnsByRegion}</div>
        </section>
      </div>
