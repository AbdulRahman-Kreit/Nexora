...
export default function TimelineFilter() {
    ...
    return (
        ...
        bg-[#161616] w-full border-t-2 border-gray-500 px-5`}>
            ...
            <div className={`flex flex-row min-w-[200px] border border-gray-500 
                my-2 rounded font-semibold`}>
                <button onClick={() => setCount(count - 7)} 
                className='p-2 duration-200 hover:bg-[#006fff]'>
                    <FontAwesomeIcon icon={faChevronLeft} />
                </button>
                <p className={`w-9/10 border border-gray-500 h-full flex
