...
export default function CustomersWithoutOrdersSkeleton() {
    return (
        <div className="bg-linear-to-r from-[#151a21] to-[#161616] ml-1 p-6 h-96 border-l-3 border-[#4a7fce] animate-pulse relative overflow-hidden">
            ...
            <div className="flex items-end justify-between h-56 px-2 gap-3">
                ...
                return (
                    ...
                    <div 
                        className="w-full max-w-[25px] bg-[#1a1a1a] rounded-t-[5px]" 
